  ...
  async (productData, { rejectWithValue }) => {
    try {
      const response = await axios.post(
        "https://api.bzcart.store/api/products/create-product",
        productData
      );
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        "https://api.bzcart.store/api/products/products"
      );
      return response.data;
    } catch (err) {
      return rejectWithValue(
...
export const fetchProductsByCategory = createAsyncThunk(
  ...
  async (categoryId, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        `https://api.bzcart.store/api/products/category/${categoryId}`
      );
      return response.data;
    } catch (err) {
      return rejectWithValue(
...
export const fetchProductById = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        `https://api.bzcart.store/api/products/product/${id}`
      );
      return response.data;
    } catch (err) {
      return rejectWithValue(
...
export const fetchReviews = createAsyncThunk(
  ...
  async (productId, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        `https://api.bzcart.store/api/reviews/${productId}`
      );
      return response.data;
    } catch (err) {
      return rejectWithValue(
  ...
  async (productId, { rejectWithValue }) => {
    try {
      const response = await axios.delete(
        `https://api.bzcart.store/api/products/product/${productId}`
      );
